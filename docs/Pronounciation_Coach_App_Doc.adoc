...
-*Phoneme* (Entity):: The smallest contrastive sound unit in a language that distinguishes word meanings. 
...
-*Pronunciation Challenge* (Entity):: A specific linguistic target varying from individual phonemes to complex tongue twisters, scaled by difficulty. 
...
image::class_diagram_png.png[Class Diagram for Quiz Session, Persistence, and Prosody Evaluation,width=600,align=center]
